...
MegaFilter.prototype = {
	...
	*/
	...
	initResponsive: function(){
		...
		var id = 'mfilter-box-' + jQuery('[id^="mfilter-box"]').length,
			cnt = jQuery('<div class="box mfilter-box mfilter-column_left init">')
				.prependTo( jQuery('.mfilter-before-box') ),
	...
	_initPrice: function() {
		var self		= this,
			...
			benefitMin = self._box.find('[id="price-benefits-min"]').html(priceRange.min),
			benefitMax = self._box.find('[id="price-benefits-max"]').html(filters.price ? filters.price[1] : priceRange.max ),
