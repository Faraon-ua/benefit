namespace Benefit.Domain.Migrations
{
    ...
    public partial class AddUsers : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        BusinessLevel = c.Int(),
                        Status = c.Int(),
                        ReferalId = c.String(maxLength: 128),
                        RegisteredOn = c.DateTime(nullable: false, storeType: "datetime2"),
                        CurrentBonusAccount = c.Double(nullable: false),
                        CurrentPointsAccount = c.Double(nullable: false),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.ApplicationUsers", "ReferalId", "dbo.ApplicationUsers");
            ...
            DropIndex("dbo.ApplicationUsers", new[] { "ReferalId" });
            DropIndex("dbo.ApplicationUsers", new[] { "ExternalNumber" });
            DropIndex("dbo.ApplicationUsers", new[] { "CardNumber" });
            DropIndex("dbo.ApplicationUsers", new[] { "FullName" });
